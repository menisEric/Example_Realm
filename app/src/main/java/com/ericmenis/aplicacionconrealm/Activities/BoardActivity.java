package com.ericmenis.aplicacionconrealm.Activities;
...
import com.ericmenis.aplicacionconrealm.Adapters.BoardAdapter;
...
public class BoardActivity extends AppCompatActivity implements RealmChangeListener<RealmResults<Board>>, AdapterView.OnItemClickListener {
    ...
    private void showAlertForCreatingBoard(String title, String message){
        ...
        final EditText input = (EditText) viewInflate.findViewById(R.id.editTextNewBoard);
